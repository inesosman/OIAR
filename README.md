...
OIAR is an approach for creating a new ontology from a simple merge of multiple ontologies using pairwise alignments between them. It automatically customizes and merges multiple large ontologies at a time in very short times.
...
![FMA-NCI alignment](https://github.com/inesosman/OIAR/blob/master/Figures/cell1.png)
...
![FMA-SNOMED alignment](https://github.com/inesosman/OIAR/blob/master/Figures/cell2.png)
...
![FMA-SNOMED alignment](https://github.com/inesosman/OIAR/blob/master/Figures/cell3.png)
...
Here is the definition/description of __Abdominal_lymph_node__ class in its original ontology ([FMA](https://github.com/inesosman/OIAR/blob/master/Input/FMA.owl) (Ont1)) :
...
The above-mentioned correspondences will lead to addition of three equivalence axioms between __Abdominal_lymph_node__ class (from FMA (Ont1)) and its three matched classes __Intra-abdominal_Lymph_Node__ (from NCI (Ont2)), __Abdominal_lymph_node_group__ (from SNOMED (Ont3)), and __Abdominal_lymph_node_structure__ (from SNOMED (Ont3)). For this example, we chose to give our future merged ontology this IRI : "http://integration". 
...
You can view and download all our merged ontologies from the [Output folder](https://github.com/inesosman/OIAR/tree/master/Output).
...
You can download and view this [non refactored merged ontology](https://github.com/inesosman/OIAR/blob/master/Results/Merge_LargeBio.owl) from the Output folder.
...
You can download and view this [refactored merged ontology](https://github.com/inesosman/OIAR/blob/master/Output/Merge_LargeBio_Refactored.owl) from the Results folder.
